...
extern "C" void kernel_main(uint32_t kernel_info_block)
{
	...
	//Search for the disk we booted from
	print("Looking for boot disk...\n");
	...
	if (diskIndex == 0) {print("Boot disk detection error! Please reboot your PC\n");return;}
	kernel_drivers->ActivateAll();	//activates all drivers
	...
	print("OS ready... Schedules running.\n");
   	...
   	while(1)		//Runs infinitely, checking if there is any schedule to rum
	{
